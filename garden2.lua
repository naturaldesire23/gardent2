...
--// Beautiful Key GUI - FIXED VERSION
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "KeySystemGUI"
ScreenGui.Parent = plr:WaitForChild("PlayerGui")  -- Parent at the end
...
Frame.Parent = ScreenGui  -- Important: Parent to ScreenGui
...
print("GUI created successfully!") -- Debug message
...
CheckBtn.MouseButton1Click:Connect(function()
    if TextBox.Text:lower() == "cracked" then
        ...
        TextBox.Text = ""
        Label.Text = "✗ Invalid Key! Try again."
...
print("Script loaded completely! UI should be visible.")