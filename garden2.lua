...
function load2xScript()
    ...
    local placements = {
        ...
        {
            time = 85, unit = "unit_golem_dragon",
            data = {
                Valid = true,
                Rotation = 180,
...
function load3xScript()
    ...
    local placements = {
        ...
        -- Golem Dragon (Late Game)
        {
            time = 57, unit = "unit_golem_dragon",
            data = {
                Valid = true,
                Rotation = 180,
                Position = Vector3.new(-855.949951171875, 61.93030548095703, -163.9769287109375),
