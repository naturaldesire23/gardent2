...
local function checkDiscordWhitelist(username)
    StatusLabel.Text = "Status: Checking Whitelist..."
    
    -- Replace this URL with your actual GitHub Gist URL from the Discord bot
    local gistUrl = "YOUR_GIST_URL_HERE"  -- You'll get this from !gist_url command
...
CheckBtn.MouseButton1Click:Connect(function()
    ...
    -- Method 1: Check Discord whitelist
    if checkDiscordWhitelist(plr.Name) then
        StatusLabel.Text = "Status: Discord Whitelist Verified"
    ...
    elseif key == "cracked" then
        StatusLabel.Text = "Status: Key Verified Successfully"
        ...
        StatusLabel.Text = "Status: Invalid Key/Not Whitelisted"
        TextBox.Text = ""
        Label.Text = "✗ Invalid Key/Not Whitelisted!"
